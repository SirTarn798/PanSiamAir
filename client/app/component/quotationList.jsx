...
export default function QuotationList(props) {
  ...
  const createQuotation = () => {
    router.push(`/service/docs/quotation/create?RF_Id=${props.quotation.Request_form.RF_Id}`)
  }
  return (
    <div className="grid grid-cols-[3fr_3fr_3fr_2fr_1fr_2fr] grid-rows-1 bg-primaryBg rounded-3xl p-3 items-center">
      <p>{props.quotation.Request_form.RF_Id}</p>
      <p>{props.quotation.Request_form.RF_Date}</p>
      <p>{props.quotation.AC.AC_Serial}</p>
      <p>{props.quotation.AC.AC_Model}</p>
