...
export default function DistributeVoucherPage() {
  ...
  useEffect(() => {
    getRequests(1, "accepted_wait_approve_distribute_voucher");
  }, []);
    ...
    <div className="flex flex-col gap-10 w-screen h-screen p-10">
      ...
      <div className="flex gap-20 text-lg">
        <p
          ...
          onClick={() => getRequests(1, "accepted_wait_approve_distribute_voucher")}
        >
          รอยืนยันใบสำคัญจ่าย
        </p>
        <p
